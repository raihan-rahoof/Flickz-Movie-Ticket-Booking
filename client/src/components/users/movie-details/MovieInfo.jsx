        ...
        <div className="pt-2 flex flex-col md:flex-row md:justify-center md:items-center gap-6 md:gap-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <div className="flex gap-2 mt-2">
              <Link to={`/moive/available-shows/${props.flim.id}`} className="login-btn text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Get tickets </Link>
